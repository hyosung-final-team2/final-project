...
const SlideUpModal = ({ isOpen, onClose, children, headerText, buttonText, isButton = true, buttonStyle }) => {
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            ...
            <div className='flex justify-center mb-4'>
              <div className='bg-gray-200 rounded-3xl w-2/12 h-2' onClick={onClose}></div>
            </div>
            ...
            {/* bottom */}
            {isButton && <BottomButton buttonStyle={buttonStyle} buttonText={buttonText} />}
          </motion.div>
        </>
      )}
    </AnimatePresence>
