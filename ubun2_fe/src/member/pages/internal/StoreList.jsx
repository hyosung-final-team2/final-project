...
function StoreList() {
  ...
  return (
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', flexWrap: 'wrap' }}>
      <div style={{flex:0.7}} className='w-full px-3 py-2 text-xl font-bold bg-white flex items-center'><div>등록된 상점({storeList?.data?.data?.length})</div></div>
