  ...
  return (
    <>
        ...
        >
          <div className='flex flex-col'>
            <div className='flex items-center justify-between px-4 py-3 pt-8 pb-0 text-xl'>
              ...
              >
                <input type='input' value={category === null ? '전체' : category} className='min-w-0 bg-transparent cursor-pointer max-w-[10dvw]' readOnly />
      ...
      <SlideUpModal
        ...
        headerText={isClickedCategory ? '카테고리' : null}
      >
        {isClickedCategory ? (
          <SelectCategoryModal categoryList={categoryList?.data?.data} setCategory={setCategory} setModalState={setModalState} />
        ) : (
          <Announcement />
        )}
      </SlideUpModal>
