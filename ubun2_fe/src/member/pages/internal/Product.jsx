...
function Product() {
  ...
  const orderOptionFunc = orderOption => {
    if (orderOption === 'SINGLE') {
      return (
        <div className='flex'>
          <div className='flex items-center gap-1 p-1 px-3 bg-blue-200 rounded-3xl text-md'>
            <SingleOrder />
            <span>단건</span>
          </div>
        </div>
      ...
      return (
        <div className='flex'>
          <div className='flex items-center gap-1 p-1 px-3 bg-orange-200 rounded-3xl text-md'>
            <SubscriptionOrder />
            <span>정기</span>
          </div>
        </div>
    ...
    <div className='flex flex-col w-full'>
      ...
      <div className='p-6'>
        <div className='mb-3'>
          ...
          <div className='text-2xl' style={{ letterSpacing: '0.5px' }}>
            {product?.productName}
          </div>
        </div>
        <div className='mb-3'>
