            ...
            <form onSubmit={e => submitForm(e)}>
              ...
              <div className='text-right text-primary'>
                <Link to='/customer/forgot-password'>
                  <span
                      className='text-main text-sm  inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200'>
                    Forgot Password?
                  </span>
                </Link>
              </div>
              ...
              <button type='submit'
                      className={'btn mt-2 w-full btn-primary tracking-widest	bg-main text-white' + (loading ? ' loading' : '')}>
                로그인
              </button>
              ...
              <div className='text-center mt-4'>
                ...
                <Link to='/customer/register'>
                  <span
                      className=' text-main inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200'>Register</span>
                </Link>
              </div>
            </form>
          </div>
