...
const MemberTableFeature = ({ tableColumns, onSearch, setExcelModal, setOpenMemberInsertModal }) => {
  ...
  return (
    <div className='flex items-center justify-between flex-column md:flex-row flex-wrap space-y-4 md:space-y-0 p-4 bg-white dark:bg-gray-900'>
      ...
      <div className='flex gap-2'>
        ...
        <button onClick={() => setOpenMemberInsertModal(true)} className={`${commonButtonStyles} bg-white text-gray-600 hover:text-main hover:bg-slate-50`}>
          회원 등록
        </button>
...
export default MemberTableFeature;
