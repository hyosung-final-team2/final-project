...
const TableHeadCell = ({ colunmName, handleSort, headerType = 'member', nonSort = false }) => {
  ...
  const handleIsDesc = () => !nonSort && setIsDesc(!isDesc);

  return (
    <Table.HeadCell className='bg-gray-100 text-main text-[0.9dvw]' onClick={handleIsDesc}>
