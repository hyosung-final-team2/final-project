export const CALENDAR_EVENT_STYLE = Object.freeze({
    ...
    "SINGLE": "bg-pink-200 dark:bg-pink-600 dark:text-pink-100",
    "SUBSCRIPTION":"bg-blue-200 dark:bg-blue-600 dark:text-blue-100",
    "PRICE": "hover:underline cursor-pointer font-medium ",
});